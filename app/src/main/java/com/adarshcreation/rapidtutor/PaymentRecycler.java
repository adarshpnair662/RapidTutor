...
public class PaymentRecycler extends RecyclerView.Adapter<PaymentRecycler.MyViewHolder> {

    private Context mContext ;
    private List<Payment> mData ;


    public PaymentRecycler(Context mContext, List<Payment> mData) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        payment_details ="₹ " + mData.get(position).getAmount() + " send to " + mData.get(position).getName();
