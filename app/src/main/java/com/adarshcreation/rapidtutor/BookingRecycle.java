...
public class BookingRecycle extends RecyclerView.Adapter<BookingRecycle.MyViewHolder> {
    ...
    public BookingRecycle(Context mContext, List<Book> mData,int n) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageButton cancel, delete, accept;
        LinearLayout card;
        ...
        public MyViewHolder(View itemView) {
            ...
            accept = itemView.findViewById(R.id.accept_booking);
        }
    }
