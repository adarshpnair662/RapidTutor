...
public class BookingHistory extends AppCompatActivity {
    ...
    void getUserID(final MyCallback myCallback)
    {
        db.collection("booking")
                .whereEqualTo("receiver", uid).orderBy("timestamp")
                .get()
                    ...
                    if (document.exists()) {
                        ...
                        try {
                            ...
                            if(d1.compareTo(d2) > 0) {
                                ...
                                try {
                                    Date d3 = stdformat.parse(currentTime);
                                    Date d4 = sdformat.parse( Btime);
                            ...
                            if (currentDate.equals(Bdate)) {
                                if (validTime) {
                                    ...
                                    UserNameGet(Rid, new MyCallback() {
                                        ...
                                        public void onCallback(final String name) {
                                            ...
                                            RecyclerView myrv = (RecyclerView) findViewById(R.id.booking_today_recycle);
                                            BookingRecycle myAdapter = new BookingRecycle(BookingHistory.this, book1, 2);
                                            myrv.setLayoutManager(new GridLayoutManager(BookingHistory.this, 1));
                                ...
                                UserNameGet(Rid, new MyCallback() {
                                    ...
                                    public void onCallback(final String name) {
                                        ...
                                        RecyclerView myrv = (RecyclerView) findViewById(R.id.booking_upcoming_recycle);
                                        BookingRecycle myAdapter = new BookingRecycle(BookingHistory.this, book2, 2);
                                        myrv.setLayoutManager(new GridLayoutManager(BookingHistory.this, 1));
                                        myrv.setAdapter(myAdapter);
                                    }
                                });
                            ...
                            if (validDate) {
                                UserNameGet(Rid, new MyCallback() {
                                    ...
                                    public void onCallback(final String name) {
                                        ...
                                        RecyclerView myrv = (RecyclerView) findViewById(R.id.booking_recycle);
                                        BookingRecycle myAdapter = new BookingRecycle(BookingHistory.this, book3, 1);
                                        myrv.setLayoutManager(new GridLayoutManager(BookingHistory.this, 1));
                                        myrv.setAdapter(myAdapter);
                                    }
                                });
